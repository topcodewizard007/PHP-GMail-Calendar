...
class DataBaseService {
	...
	public function selectOne($tblname, $rowID, $field) {
		$query = "SELECT $field FROM $tblname where id=$rowID";
		echo $query;
		$select_fetch = mysqli_query($this->con, $query);
		if($select_fetch){
				echo $select_fetch;
				return $select_fetch;
		} else {
