...
?>
    ...
    <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="#">
         Extract Address From GMail | To Save DataBase 
        </a>
        <div class="pull-right">
        <a class="btn btn-info extract_contacts_gmail" href="#"> Extract Contacts From GMail</a>
        <a class="btn btn-info save_contacts_db" href="#"> Save Into DataBase</a>
        </div>
    </nav>
    <div class="container">
        <div class="row">
    ...
    <nav class="navbar navbar-light bg-light mb-2">
        ...
        <div class="pull-right">
        <a class="btn btn-info" href="/emailsend">Go to EmailSend Page</a>
        </div>
    </nav>
    <nav class="navbar navbar-light bg-light mb-2">
        <a class="navbar-brand" href="#">
         Basic "inbox" of saved email from DB 
        </a>
        <div class="pull-right">
        <a class="btn btn-info" href="/emails">Go to MailBox Page</a>
        </div>
    </nav>
