...
foreach ($data['events_list'] as $events) {
    ...
    echo '<u><p class="crad-text"> Extened Properties</p></u>';
    foreach ($events['extendedProperties'] as $key => $value) {
        echo '<p class="card-text">' . $key . ': <small>' . json_encode($value). '</small></p>';
    }
    echo '
